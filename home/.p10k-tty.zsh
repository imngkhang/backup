# Generated by Powerlevel10k configuration wizard on 2026-05-02 at 11:30 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_MODE=acsii
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%B%F{7}▓▒░%f'
  # The left end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%B%F{7}░▒▓%f'
  # The left end of left prompt.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%B%F{7}░▒▓%f'
  # The right end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_LAST_SEGMENT_END_SYMBOL='%B%F{7}▓▒░%f'
  ...
  typeset -g POWERLEVEL9K_LOCK_ICON='readonly'
  ...
  typeset -g POWERLEVEL9K_DIR_HOME_VISUAL_IDENTIFIER_EXPANSION='%Bhome'
  typeset -g POWERLEVEL9K_DIR_CONFIG_VISUAL_IDENTIFIER_EXPANSION='%Bconfig'
  typeset -g POWERLEVEL9K_DIR_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='%Bdir'
  # Icon ổ đĩa ngoài (An toàn, khó lỗi)
  typeset -g POWERLEVEL9K_DIR_EXTERNAL_DRIVE_VISUAL_IDENTIFIER_EXPANSION='%Bexternaldrive'
  typeset -g POWERLEVEL9K_DIR_EXTERNAL_DRIVE_FOREGROUND=3
  typeset -g POWERLEVEL9K_DIR_CONTENT_EXPANSION='%B$P9K_CONTENT'
  # Read-only.
  typeset -g POWERLEVEL9K_DIR_HOME_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION="%B${POWERLEVEL9K_DIR_HOME_VISUAL_IDENTIFIER_EXPANSION} ${POWERLEVEL9K_LOCK_ICON}"
  typeset -g POWERLEVEL9K_DIR_CONFIG_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION="%B${POWERLEVEL9K_DIR_CONFIG_VISUAL_IDENTIFIER_EXPANSION} ${POWERLEVEL9K_LOCK_ICON}"
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION="%B${POWERLEVEL9K_DIR_DEFAULT_VISUAL_IDENTIFIER_EXPANSION} ${POWERLEVEL9K_LOCK_ICON}"
  # Hiện: Ổ đĩa + Ổ khóa khi không có quyền ghi trên đĩa ngoài
  typeset -g POWERLEVEL9K_DIR_EXTERNAL_DRIVE_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION="%B${POWERLEVEL9K_DIR_EXTERNAL_DRIVE_VISUAL_IDENTIFIER_EXPANSION} ${POWERLEVEL9K_LOCK_ICON}"
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='%Berr'

  # Status when the last command was terminated by a signal.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=1
  function my_status_formatter() {
    emulate -L zsh
    if (( P9K_STATUS == 139 )) || [[ "$P9K_CONTENT" == *SIGSEGV* ]]; then
      typeset -g my_status_format="%BSIXSEVEN(11)"
    else
      typeset -g my_status_format="%B$P9K_CONTENT"
    fi
  }
  functions -M my_status_formatter 2>/dev/null
  # Use terse signal names: "INT" instead of "SIGINT(2)".
  typeset -g POWERLEVEL9K_STATUS_VERBOSE_SIGNAME=true 
  typeset -g POWERLEVEL9K_STATUS_CONTENT_EXPANSION='${$((my_status_formatter()))+${my_status_format}}'
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_CONTENT_EXPANSION='${$((my_status_formatter()))+${my_status_format}}'
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION='%Berr'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_VISUAL_IDENTIFIER_EXPANSION='%Bexectime'
  # Custom prefix.
  ...
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=6 
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=%BOVERTYPE
  ...
  typeset -g POWERLEVEL9K_RAM_VISUAL_IDENTIFIER_EXPANSION='%Bram'
  ...
  typeset -g POWERLEVEL9K_LOAD_CONTENT_EXPANSION='%B$P9K_CONTENT'
  # Custom icon.
  typeset -g POWERLEVEL9K_LOAD_VISUAL_IDENTIFIER_EXPANSION='%Bcpu'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION='time'
  # Custom prefix.
