# Generated by Powerlevel10k configuration wizard on 2026-05-01 at 19:18 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_EXTERNAL_DRIVE_VISUAL_IDENTIFIER_EXPANSION=$'\uf0a0'
  # Màu sắc riêng cho đĩa ngoài (Màu cam hoặc màu vàng cho nổi)
  typeset -g POWERLEVEL9K_DIR_EXTERNAL_DRIVE_FOREGROUND=208
  # Read-only.
  typeset -g POWERLEVEL9K_DIR_HOME_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION="${POWERLEVEL9K_DIR_HOME_VISUAL_IDENTIFIER_EXPANSION} ${POWERLEVEL9K_LOCK_ICON}"
  typeset -g POWERLEVEL9K_DIR_CONFIG_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION="${POWERLEVEL9K_DIR_CONFIG_VISUAL_IDENTIFIER_EXPANSION} ${POWERLEVEL9K_LOCK_ICON}"
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION="${POWERLEVEL9K_DIR_DEFAULT_VISUAL_IDENTIFIER_EXPANSION} ${POWERLEVEL9K_LOCK_ICON}"
  # Hiện: Ổ đĩa + Ổ khóa khi không có quyền ghi trên đĩa ngoài
  typeset -g POWERLEVEL9K_DIR_EXTERNAL_DRIVE_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=$'\uf0a0 \uf023'
  #####################################[ vcs: git status ]######################################
  ...
  function my_status_formatter() {
    emulate -L zsh
    # Kiểm tra nếu Exit Code là 139 HOẶC nội dung mặc định chứa chữ SIGSEGV
    if (( P9K_STATUS == 139 )) || [[ "$P9K_CONTENT" == *SIGSEGV* ]]; then
      typeset -g my_status_format="SIXSEVEN(11)"
    else
      # Nếu là các lỗi khác thì giữ nguyên văn bản mặc định (vídụ: 127, 1, SIGINT...)
      typeset -g my_status_format=$P9K_CONTENT
    fi
  }
  ...
  #####################################[ swap: used swap ]######################################
  # Swap color.
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=208
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=46
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=178
  # Load color when load is over 70%.
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_FOREGROUND=166
  # Custom icon.
  typeset -g POWERLEVEL9K_LOAD_VISUAL_IDENTIFIER_EXPANSION=$'\U000f035b'
