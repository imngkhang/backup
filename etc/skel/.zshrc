...
# see /usr/share/doc/zsh/examples/startup-files
# for examples
...
# for setting history length see HISTSIZE and SAVEHIST in zshparam(1)
HISTSIZE=1000
SAVEHIST=2000
...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='${debian_chroot:+($debian_chroot)}%F{2}%n@%m%f:%F{4}%~%f%# '
fi
